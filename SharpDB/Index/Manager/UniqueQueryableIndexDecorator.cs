    ...
    where TK : IComparable<TK>
{
    ...
    public Task<TV?> GetAsync(TK key) => inner.GetAsync(key);
    public Task PutAsync(TK key, TV value) => inner.PutAsync(key, value);
    public Task<bool> RemoveAsync(TK key) => inner.RemoveAsync(key);
    public Task<bool> ContainsKeyAsync(TK key) => inner.ContainsKeyAsync(key);
